...
class ExplositionGallery {
    ...
    initModal() {
            ...
            <div class="${explosionImagesClassName}">
                ${Array.from(this.linkNodes)
                    ...
                    <img src="${linkNode.getAttribute('href')}" alt="${
                        ...
                        }" class="${explosionImageClassName}" data-title="${
                            linkNode.dataset.title
        ...
        this.explosionCouterNode = this.modalContainerNode.querySelector(
        ...
        this.explosionSummaryContentNode =
            this.modalContainerNode.querySelector(
    ...
    switchChanges(hasSummaryAnimation) {
        ...
        // установить состояния контроллов
        // установить счетчик
    ...
    changeCounter() {
        this.explosionCouterNode.innerText = `${this.currentIndex + 1}/${
            this.size
        }`;
    }
